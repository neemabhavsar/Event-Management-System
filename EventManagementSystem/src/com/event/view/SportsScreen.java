...
public class SportsScreen implements IScreen{
	AppController appController;
	PImage corp_event,img,event_1,event_2,event_3,event_4;
	Menu menu;
	
	public SportsScreen(AppController appController){
	...
	public void mousePressed(PApplet applet) {
		...
		*/ 
		...
		if (applet.mouseX > 295 && applet.mouseX < 330 						//Sports Event
	...
	public void draw(PApplet applet) {
		...
		*/ 
		...
		corp_event = applet.loadImage("sports_event.png");
		applet.image(corp_event, 22,135);
		
		event_1 = applet.loadImage("sports_event1.png");
		applet.image(event_1, 22,240);

		event_2 = applet.loadImage("sports_event2.png");
		applet.image(event_2, 22,305);
		event_3 = applet.loadImage("sports_event3.png");
		applet.image(event_3, 22,370);
		event_4 = applet.loadImage("sports_event4.png");
	...
	public void getCostAndSetScreen(){
		...
		*/ 
		double cost = (new SportsEvent(new ConcreteEvent())).getCost();
