...
public class CharityScreen implements IScreen{
	AppController appController;
	PImage corp_event,img,event_1,event_2,event_3,event_4;
	Menu menu;
	
	public CharityScreen(AppController appController){
	...
	public void mousePressed(PApplet applet) {
		 ...
		 * Based on the Action Performed on the Charity Screen the Action is performed to book a event or Change Screen
		 * Done @ by Preeti 
		...
		*/ 
		...
		if (applet.mouseX > 295 && applet.mouseX < 330 						//Charity Event
	...
	public void draw(PApplet applet) {
		...
		*/ 
		...
		corp_event = applet.loadImage("charity_logo.png");
		applet.image(corp_event, 22,135);
		
		event_1 = applet.loadImage("charity_event1.png");
		applet.image(event_1, 22,240);

		event_2 = applet.loadImage("charity_event2.png");
		applet.image(event_2, 22,305);
		event_3 = applet.loadImage("charity_event3.png");
		applet.image(event_3, 22,370);
		event_4 = applet.loadImage("charity_event4.png");
